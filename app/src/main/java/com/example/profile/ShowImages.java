...
public class ShowImages extends AppCompatActivity {
    ...
    public void fetchImages(){
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://jobfinder900.000webhostapp.com/fetchImages.php",
                        ...
                        try {
                            ...
                            if(succes.equals("1")){
                                ...
                                for(int i=0;i<jsonArray.length();i++){
                                    ...
                                    String url = "https://jobfinder900.000webhostapp.com/Images/"+imageurl;
